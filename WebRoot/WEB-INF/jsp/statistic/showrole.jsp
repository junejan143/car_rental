...
<body>
    ...
    <li>用户分角色查看</li>
        ...
        <div class="tools">
            <form action="sys/toShowRoleAnalysisAction.action?role_id=<s:property value="role_id" />" method="post" name="searchForm">
                <!-- 隐藏域 -->
     ...
     <div class="pagin">
        ...
        <s:select list="#{'10':'每页显示10条','5':'每页显示5条'}" id="page_size" onchange="toPage('6')" cssStyle="border: 1px solid #6CB2E3;" value="pageBean.pageSize"></s:select>
